          ...
          <Script id="ga4-script" strategy="afterInteractive">
            {`
              ...
              gtag('config', '${gaId}', {
                ...
                send_page_view: true,
                custom_map: {
                  'custom_parameter_1': 'innovation_synergy_ai_boston',
                  'location': 'greater_boston',
                  'service_area': 'cambridge_back_bay_financial_district'
                },
                custom_parameters: {
                  'region': 'Boston',
                  'state': 'Massachusetts',
                  'business_focus': 'biotech_finance_education'
                }
              });
            `}
          </Script>
