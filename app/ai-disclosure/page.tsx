...
export const metadata: Metadata = {
  title: "AI Disclosure - Innovation Synergy AI Inc.",
  description: "Transparency disclosure about Innovation Synergy AI's use of artificial intelligence in business consulting and infrastructure services.",
}
