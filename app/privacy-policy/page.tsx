...
export const metadata: Metadata = {
  title: "Privacy Policy - Innovation Synergy AI Inc.",
  description: "Innovation Synergy AI's comprehensive privacy policy detailing how we collect, use, and protect your personal information.",
}
