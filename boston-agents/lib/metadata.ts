...
// Base configuration for the Boston website
export const siteConfig = {
  name: 'Innovation Synergy AI Boston',
  url: 'https://bostonagents.ai',
  ogImage: 'https://bostonagents.ai/og-image-boston-ai-agents.jpg',
  twitterImage: 'https://bostonagents.ai/twitter-card-boston-ai-agents.jpg',
  description: 'Innovation Synergy AI Boston delivers AI infrastructure consulting for Greater Boston businesses. Voice agents, automation for biotech, finance, and education sectors. Serving Cambridge, Back Bay, Financial District & metro Boston.',
  phone: '+1-617-AI-BOSTON',
  email: 'boston@innovationsynergyai.com',
  businessName: 'Innovation Synergy AI Boston',
  foundingYear: '2024'
}

// Keywords for Boston-specific service categories
export const keywordCategories = {
  primary: [
    'Boston AI consulting',
    'Greater Boston business automation',
    'Cambridge voice AI agents',
    'biotech workflow automation',
    'financial services process automation',
    'Boston AI infrastructure consulting',
    'Massachusetts small business AI',
    'Innovation Synergy AI Boston'
  ],
  services: [
    'voice agents Boston',
    'AI consulting Greater Boston',
    'Boston business tech integration',
    'Cambridge custom AI solutions',
    'biotech data enrichment services',
    'Boston remote AI installation',
    'Financial District customer service automation',
    'Boston conversational AI agents'
  ],
  locations: [
    'Cambridge AI consulting',
    'Back Bay AI services',
    'Financial District AI agents',
    'Kendall Square AI consulting',
    'Somerville AI automation',
    'Brookline AI infrastructure'
  ],
  industry: [
    'Boston biotech AI transformation',
    'Harvard Medical AI consulting',
    'MIT startup automation',
    'Boston finance AI optimization',
    'Cambridge AI workflow optimization',
    'Massachusetts professional AI services'
  ]
}
