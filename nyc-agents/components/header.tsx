        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <div className="text-white-50">
              ...
              <div className="text-xs text-neutral-400 -mt-1">NYC 24/7 Operations</div>
            </div>
          </Link>
            ...
            <div className="flex items-center space-x-4 ml-4 pl-4 border-l border-neutral-700">
              {locationLinks.map((location) => (
                <Link
                  ...
                  className={`transition-colors duration-300 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-tiffany-500 rounded px-2 py-1 ${
                    location.label === 'NYC' 
                      ? 'text-tiffany-500 font-semibold' 
                      : 'text-neutral-400 hover:text-tiffany-500 focus:text-tiffany-500'
                  }`}
                  aria-label={location.ariaLabel}
                  aria-current={location.label === 'NYC' ? 'page' : undefined}
                >
                  {location.label}
                </Link>
              ))}
              ...
              <div className="space-y-2">
                {locationLinks.map((location) => (
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`block transition-colors duration-300 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-tiffany-500 rounded px-2 py-1 ${
                      location.label === 'NYC' 
                        ? 'text-tiffany-500 font-semibold' 
                        : 'text-neutral-400 hover:text-tiffany-500 focus:text-tiffany-500'
                    }`}
