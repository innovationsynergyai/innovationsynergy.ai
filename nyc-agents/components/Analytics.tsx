          ...
          <Script id="ga4-script" strategy="afterInteractive">
            {`
              ...
              gtag('config', '${gaId}', {
                ...
                send_page_view: true,
                custom_map: {
                  'custom_parameter_1': 'innovation_synergy_ai_nyc',
                  'location': 'new_york_metro_area',
                  'service_area': 'all_5_boroughs_wall_street_financial_district'
                },
                custom_parameters: {
                  'region': 'NYC',
                  'state': 'New York',
                  'business_focus': 'finance_real_estate_startups',
                  'operation_mode': '24_7_nyc_pace',
                  'boroughs_served': 'manhattan_brooklyn_queens_bronx_staten_island'
                }
              });
            `}
          </Script>
